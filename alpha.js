...
if (BOT_TOKEN == '7495050835:AAFxGjRLyUGzX01NM7p37LXF3xlElxUWqmY') {
...
async function startalpha() {
    bot.on('callback_query', async (alpha) => {
        ...
        const username = user.username ? user.username : "𝐏𝐑𝐄𝐒𝐈𝐃𝐄𝐍 𝐋𝐄𝐀𝐃𝐄𝐑 𝐋𝐎𝐑𝐃 𝐌𝐎𝐂𝐇 𝐍𝐀𝐍𝐆𝐆 𝐗𝐑 𝐁𝐎𝐓";
        ...
        try {
            switch (action[0]) {
                ...
                case "owner": {
                    ...
                    reply(`𝐏𝐑𝐄𝐒𝐈𝐃𝐄𝐍 𝐋𝐄𝐀𝐃𝐄𝐑 𝐋𝐎𝐑𝐃 𝐌𝐎𝐂𝐇 𝐍𝐀𝐍𝐆𝐆 𝐗𝐑 [${OWNER_NAME}](${OWNER[0]}) 👑`)
                }
                break
                case "ytmp3": {
    ...
    bot.command('help', async (alpha) => {
        ...
        await alpha.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{
                        text: 'MY GROUP 🇮🇩𝐑𝐎𝐎𝐌 𝐓𝐄𝐑𝐌𝐔𝐗 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋🇮🇩',
                        url: "https://t.me/PRESIDENNANGGXR_BOT"
                    }, {
                        text: 'OWNER 😁',
                        url: OWNER[0]
                    }]
    ...
    bot.telegram.getMe().then((getme) => {
        console.table({
            ...
            "Recod": "https://t.me/PRESIDENNANGGXR_BOT"
        })
    })
}
startalpha()
