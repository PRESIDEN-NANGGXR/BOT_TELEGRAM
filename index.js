...
module.exports = alpha = async (alpha, bot) => {
    ...
    try {
        ...
        switch (command) {
            case "tes": {
                reply("𝐏𝐑𝐄𝐒𝐈𝐃𝐄𝐍 𝐋𝐄𝐀𝐃𝐄𝐑 𝐋𝐎𝐑𝐃 𝐌𝐎𝐂𝐇 𝐍𝐀𝐍𝐆𝐆 𝐗𝐑 𝐁𝐎𝐓`")
            }
            break
            case 'owner':
            case 'creator': {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            [{
                                ...
                                text: 'INSTAGRAM',
                                url: "https://www.instagram.com/@presiden_nanggxr"
                            }]
                        ]
                    }
                })
            ...
            break
            case 'play': {
                if (!text) return reply(`Kirim perintah:\n${prefix+command} judul lagu\n\nContoh penggunaan:\n\`${prefix+command} bot WhatsApp PRESIDEN NANGG XR BOT\``)
